...
def nokia_analyze():
    ...
    if result.get("success"):
        try:
            ...
            score_load_balancing_rows(result.get("rows") or [], site_key_fields=("mrbts", "site_id"))
            score_load_balancing_rows(result.get("review_rows") or [], site_key_fields=("mrbts", "site_id"))
        except Exception:
            pass
