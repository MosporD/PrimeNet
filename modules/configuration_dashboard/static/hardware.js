(function () {
    ...
    async function refreshStatus() {
        try {
            const res = await fetch('/api/configuration-dashboard/hardware/status');
    ...
    async function loadAreas() {
        ...
        if (!select) return;
        try {
            const res = await fetch('/api/configuration-dashboard/hardware/areas');
            const data = await res.json();
    ...
    async function loadSankey() {
        ...
        try {
            ...
            const res = await fetch('/api/configuration-dashboard/hardware/sankey?area=');
            const data = await res.json();
            if (!res.ok || !data.success) {
    ...
    function downloadExcel() {
        ...
        const url = '/api/configuration-dashboard/hardware/export?area=' + encodeURIComponent(area === 'all' ? '' : area);
