...
CANDIDATE_LST_OBJECTS: list[tuple[str, str, str, str]] = [
    ...
    ('UCELL', 'UMTS Cell', '3G', '3G'),
    ('NODEBFUNCTION', 'NodeB Function', '3G', '3G'),
    ('NODEB', 'NodeB', '3G', '3G'),
    ('GCELL', 'GSM Cell', '2G', '2G'),
    ('BTSFUNCTION', 'BTS Function', '2G', '2G'),
    ...
    *,
    ...
    for object_name, label, technology, group in CANDIDATE_LST_OBJECTS:
        ...
        items.append({
            ...
            'recommended': object_name.upper() in (
                'CELL', 'ENODEBFUNCTION', 'UCELL', 'NODEBFUNCTION', 'GCELL', 'BTSFUNCTION',
            ),
