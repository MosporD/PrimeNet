...
MODULE_VERSIONS: dict[str, str] = {
    ...
    "nokia-load-balancing": "V1.2",
    "huawei-load-balancing": "V1.2",
    "mobility-explorer": "V1.0",
    "alarm-impact": "V1.0",
    "group-health": "V1.0",
    "irat-border": "V1.0",
    "admin-panel": "V1.0",
...
HREF_MODULE_IDS: dict[str, str] = {
    ...
    "/rru-inventory": "configuration-dashboard",
    ...
    "/mobility-explorer": "mobility-explorer",
    "/alarm-impact": "alarm-impact",
