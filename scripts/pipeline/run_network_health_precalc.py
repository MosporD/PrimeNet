#!/usr/bin/env python3
"""CLI entrypoint: run Network Health offline precalc in an isolated process."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description='Build Network Health precalc tables.')
